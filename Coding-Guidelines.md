...
The easiest way to get to know Canvas Plugins is [lib/canvas/plugin.rb](https://github.com/instructure/canvas-lms/blob/master/lib/canvas/plugin.rb) and [lib/canvas/plugins/default_plugins.rb](https://github.com/instructure/canvas-lms/blob/master/lib/canvas/plugins/default_plugins.rb)
