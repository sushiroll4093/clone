...
**NOTE** You must install bundler version 1.3.5 and NOT the current version.  Currently, the gem installer uses version 1.5.1 and as such, the bundle install will fail.
