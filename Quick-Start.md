...
```
If you get an error about peer authentication failed for user "canvas", go to [this gist.](If you get an error about peer authentication failed for user "canvas", go to https://gist.github.com/AtulKsol/4470d377b448e56468baef85af7fd614)
